...
| bgpControlPlane | object | `{"enabled":false,"secretsNamespace":{"create":false,"name":"kube-system"},"statusUpdateInterval":"5s"}` | This feature set enables virtual BGP routers to be created via CiliumBGPPeeringPolicy CRDs. |
...
| bgpControlPlane.statusUpdateInterval | string | `"5s"` | Update interval of BGP status in CiliumBGPNodeConfig resource |
